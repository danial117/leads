...
import { useSigninMutation,useDataMutation } from '../hooks/leadHook'
...
export default function MedicareAdvantagePage() {
  ...
  useEffect(() => {
    ...
    script.src = `https://create.lidstatic.com/campaign/c97b6208-ff01-f18d-77b2-8e0c816c6857.js?snippet_version=2&_t=${timestamp}&callback=insertToken&f=reset`;
