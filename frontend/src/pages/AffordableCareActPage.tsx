...
import { affordableCareActDataMutation } from '../hooks/leadHook'
export default function AffordableCareActPage() {
  ...
  const { mutateAsync: signin, isLoading } = affordableCareActDataMutation()
  ...
  return (
    <Container className="small-container">
      ...
      <h1 className="my-3"> Affordable Care Act</h1>
